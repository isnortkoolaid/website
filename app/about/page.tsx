        ...
        <div className="flex flex-col items-center w-full space-y-6 px-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 w-full max-w-5xl mt-6"> 
                ...
                <Bio
                    ...
                    name="Rainger"
                    teamRole="Software"
                    text="Rainger works on the software side of Team Ingenuity, having worked on the robot's vision system along with maintaining and building out the website as it stands today. In his free time, he likes to code projects, mostly in Python or Javascript, and work on running events with Hack Club."
                    pronouns="he/him"
                    href="#"
                    className="flex justify-center items-center"
                />
        ...
        <div className="flex flex-col items-center w-full space-y-6 px-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 w-full max-w-5xl mt-6">
                ...
                <Bio
                    ...
                    name="Vincent"
                    teamRole="Hardware"
                    text="Vincent is a member of Team Ingenuity's hardware team, where he helps with robot construction and assembly. He enjoys working hands-on with mechanical components and collaborating with teammates to bring designs to life."
                    pronouns="he/him"
                    href="#"
                    className="flex justify-center items-center"
                />
        ...
        <div className="flex flex-col items-center w-full space-y-6 px-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 w-full max-w-5xl mt-6">
                <Bio
                    ...
                    name="Max"
                    teamRole="Outreach"
                    text="Max works on outreach for Team Ingenuity, helping to connect with the community and spread awareness about FIRST robotics. He assists with events, coordinates with sponsors, and works to inspire the next generation of engineers."
                    pronouns="he/him"
                    href="#"
                    className="flex justify-center items-center"
                />
